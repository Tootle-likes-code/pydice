...
class RollResultBuilder:
    ...
    def with_add_modifier(self, modifier) -> 'RollResultBuilder':
        self._dice_result = AddToRollResultDecorator(self._dice_result, int(modifier))
        return self

    def with_subtract_modifier(self, modifier) -> 'RollResultBuilder':
        self._dice_result = SubtractFromRollResultDecorator(self._dice_result, int(modifier))
        return self

    def with_multiply_modifier(self, modifier) -> 'RollResultBuilder':
    ...
    def with_exploding_modifier(self, modifier) -> 'RollResultBuilder':
